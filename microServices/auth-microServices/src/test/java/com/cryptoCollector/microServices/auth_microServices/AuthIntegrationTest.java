...
public class AuthIntegrationTest {
        ...
        public void testRegisterAndLogin() throws Exception {
                ...
                ResponseEntity<Map<String, Object>> loginResp = restTemplate.postForEntity(base + "/api/auth/login",
                                login,
                                (Class) Map.class);
        ...
        public void testInvalidLogin() throws Exception {
                ...
                ResponseEntity<String> loginResp = restTemplate.postForEntity(base + "/api/auth/login", login,
                                String.class);
